...
const PromoItem = props => {
  return (
    <tr>
      ...
      <td>
        <Link
          to={"/admin/promo/edit/" + props.promo._id}
        ...
        <a
          href="#"
          onClick={() => {
            props.deletePromo(props.promo._id);
          }}
    ...
    confirmAlert({
      ...
      buttons: [
        ...
        },
        {
          ...
          onClick: () => {
            axios
              .delete(`http://localhost:4000/promo/${promoId}`)
          ...
          <table className="table table-hover w-100">
            <thead>
              <tr>
                ...
                <th scope="col">
                  <i className="fas fa-cut mr-2 fa-lg"></i>Diskon
                </th>
                <th scope="col" style={{ width: "40%" }}>
                  <i className="fas fa-align-center mr-2 fa-lg"></i>Deskripsi
                </th>
                <th scope="col">
                  <i className="far fa-calendar-alt mr-2 fa-lg"></i>Masa Berlaku
                </th>
                <th scope="col"></th>
              </tr>
            </thead>
            <tbody>{this.mapPromoList()}</tbody>
          </table>
        </div>
      </div>
    );
