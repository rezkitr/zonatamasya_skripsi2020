...
class PromoEditForm extends Component {
  ...
  componentDidMount() {
    axios.get(`http://localhost:4000/promo/id/${this.props.promoId}`)
      .then(res => {
        this.setState({
          promo: res.data
        })
            ...
            <div className="card">
              <div className="px-3">
                ...
                <div className="float-right text-right p-3">
                  <p className="text-muted mb-1"><small>Edit Data Promo</small></p>
                </div>
              </div>
                  ...
                  this.state.promo ?
                    <Formik
                      ...
                      onSubmit={(values, { setSubmitting }) => {
                        ...
                        setTimeout(() => {
                          axios.post(`http://localhost:4000/promo/update/${this.props.promoId}`, values)
                            .then(res =>
                              confirmAlert({
                                title: 'Update Promo',
