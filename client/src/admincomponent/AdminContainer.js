  ...
  render() {
    return (
      <div id="admin-container" >
        <div className={`d-flex ${this.state.showSidebar ? '' : 'toggled'}`} id="wrapper">
          ...
          <div id="page-content-wrapper">
            <nav className="navbar navbar-expand-lg navbar-dark primary-color-dark">
              ...
              <a id="menu-toggle" className={this.state.showSidebar ? 'rotate-90-cw' : 'rotate-90-ccw'} onClick={this.toggleSideBar}><i className="fas fa-bars fa-lg text-white"></i></a>

              <Link className="navbar-brand ml-3">{this.state.menuSelected === 'rsv' ? 'Reservations' : this.state.menuSelected === 'prm' ? 'Promo' : 'Admin'}</Link>
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
                  <li className="nav-item dropdown">
                    <a className="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i className="fas fa-user"></i></a>
