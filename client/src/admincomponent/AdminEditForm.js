...
class AdminEditForm extends Component {
  ...
  componentDidMount() {
    axios.get(`http://localhost:4000/admin/id/${this.props.adminId}`)
      .then(res => {
        this.setState({
          admin: res.data
        })
            ...
            <div className="card">
              <div className="px-3">
                ...
                <div className="float-right text-right p-3">
                  <p className="text-muted mb-1"><small>Edit Data Admin</small></p>
                </div>
              </div>
                  ...
                  this.state.admin ?
                    <Formik
                      ...
                      onSubmit={(values, { setSubmitting }) => {
                        setTimeout(() => {
                          axios.post(`http://localhost:4000/admin/update/${this.props.adminId}`, values)
                            .then(res => confirmAlert({
                              title: 'Update Admin',
