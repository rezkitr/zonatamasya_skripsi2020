...
class ReservationEditForm extends Component {
  ...
  componentDidMount() {
    axios.get(`http://localhost:4000/reservation/${this.props.rsvId}`)
      .then(res => {
            ...
            <div className="card">
              <div className="px-3">
                ...
                <div className="float-right text-right p-3">
                  <p className="text-muted mb-1"><small>Edit Data Reservasi</small></p>
                  <h6 className="text-right muted" >Reservation ID : {this.props.rsvId}</h6>
                </div>
              </div>
                  ...
                  this.state.rsv && this.state.rsv.length > 0 ?
                    <Formik
                      ...
                      initialValues={
                        {
                          ...
                          participant: {
                            coordinator: {
                              coorName: this.state.rsv[0].participant.coordinator.coorName,
                              coorGender: this.state.rsv[0].participant.coordinator.coorGender,
                              coorTelp: this.state.rsv[0].participant.coordinator.coorTelp,
                              coorEmail: this.state.rsv[0].participant.coordinator.coorEmail
                            },
                      ...
                      onSubmit={(values, { setSubmitting }) => {
                        ...
                        setTimeout(() => {
                          axios.post(`http://localhost:4000/reservation/update/${this.props.rsvId}`, values)
                            .then(res => 
                            confirmAlert({
                        ...
                        <Form>
                          <div>
                            ...
                            <div className="form-group row">
                              <label htmlFor="tripName" className="col-sm-2 col-md-4 col-form-label font-weight-bold">Open Trip</label>
                            ...
                            <div className="form-group row">
                              <label htmlFor="tripStart" className="col-sm-2 col-md-4 col-form-label font-weight-bold">Start</label>
                              <div className="col-sm-10 col-md-8">
                                <Field
                                  type="text"
                                  id="tripStart"
                            ...
                            <div className="form-group row">
                              <label htmlFor="mepo" className="col-sm-2 col-md-4 col-form-label font-weight-bold">Meeting Point</label>
                              <div className="col-sm-10 col-md-8">
                                <Field
                                  type="text"
                                  id="mepo"
                            ...
                            <div className="form-group row">
                              <label htmlFor="tripDateTemp" className="col-sm-2 col-md-4 col-form-label font-weight-bold">Tgl. Keberangkatan</label>
                              <div className="col-sm-10 col-md-8">
                                <Field
                                  type="text"
                                  id="tripDateTemp"
                            ...
                            <div className="form-row">
                              <div className="form-group col-md-5">
                                <label htmlFor="coorName" className="font-weight-bold" >Pemesan</label>
                                <Field
                                  type="text"
                                  id="coorName"
                              ...
                              <div className="form-group col-md-3">
                                <label htmlFor="coorTelp" className="font-weight-bold" >No. HP</label>
                                <Field
                                  type="text"
                                  id="coorTelp"
                              ...
                              <div className="form-group col-md">
                                <label htmlFor="coorEmail" className="font-weight-bold" >Email</label>
                                <Field
                                  type="email"
                                  id="coorEmail"
                            ...
                            <hr />
                            {
                              values.participant.member.length > 0 ? (
                                <div className="form-row">
                                  <div className="form-group col-md">
                                    <label className="font-weight-bold" >Peserta</label>
                                  </div>
                          ...
                          <div className="text-right">
                            ...
                            <button className={`btn btn-sm btn-success ${isSubmitting ? 'disabled' : ''}`} type="submit" ><i className="far fa-save mr-2"></i>SIMPAN</button>
                          </div>
