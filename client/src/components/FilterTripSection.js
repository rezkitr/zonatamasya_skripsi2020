          ...
          <div className="row row-cols-md-3 row-cols-lg-5 mx-3 justify-content-center">
            <div className="col-md mb-5 text-center">
              <img
                className={
                  "rounded-circle " +
                  (this.state.filterTag === "jatim" && !this.state.reset
                    ? "flip-vertical-fwd active-filter"
                    : "flip-vertical-bck inactive-filter")
                }
            ...
            <div className="col-md mb-4 text-center">
              <img
                className={
                  "rounded-circle " +
                  (this.state.filterTag === "jateng" && !this.state.reset
                    ? "flip-vertical-fwd active-filter"
                    : "flip-vertical-bck inactive-filter")
                }
                onClick={this.handleClick}
            ...
            <div className="col-md mb-4 text-center">
              <img
                className={
                  "rounded-circle " +
                  (this.state.filterTag === "jabar" && !this.state.reset
                    ? "flip-vertical-fwd active-filter"
                    : "flip-vertical-bck inactive-filter")
                }
                onClick={this.handleClick}
            ...
            <div className="col-md mb-4 text-center">
              <img
                className={
                  "rounded-circle " +
                  (this.state.filterTag === "jogja" && !this.state.reset
                    ? "flip-vertical-fwd active-filter"
                    : "flip-vertical-bck inactive-filter")
                }
                onClick={this.handleClick}
            ...
            <div className="col-md mb-4 text-center">
              <img
                className={
                  "rounded-circle " +
                  (this.state.filterTag === "bali" && !this.state.reset
                    ? "flip-vertical-fwd active-filter"
                    : "flip-vertical-bck inactive-filter")
                }
                onClick={this.handleClick}
