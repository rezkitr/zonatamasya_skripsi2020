        ...
        <div className="container-fluid footer-body">
          <div className="row justify-content-center mt-3 px-3">
            <div className="col-md-5">
              ...
              <p><i className="fas fa-phone fa-lg mr-3"></i>+62 812-3093-3306</p>
            ...
            <div className="col-md-5">
              ...
              <hr className="white" style={{ marginBottom: "30px" }} />
              <a href="https://instagram.com/zonatamasya" target="_blank" rel="noopener noreferrer"><i className="fab fa-instagram fa-3x mr-4"></i></a>
              <a href="https://www.facebook.com/zonatamasya" target="_blank" rel="noopener noreferrer"><i className="fab fa-facebook fa-3x mr-4"></i></a>
              <a href="https://twitter.com/zonatamasya" target="_blank" rel="noopener noreferrer"><i className="fab fa-twitter fa-3x mr-4"></i></a>
            </div>
            <div className="col-md text-center">
              <img src={wilogo} alt="wonderful indonesia" width="150px" style={{ marginTop: "90px"}}/>
            </div>
          </div>
        </div>
        <div className="footer-copyright text-center py-2 mt-5">© 2020 Zona Tamasya</div>
      </footer>
    </div>
    </Element>
  )
